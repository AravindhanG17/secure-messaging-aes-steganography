<<<<<<< HEAD
# secure-messaging-aes-steganography
Secure messaging system using AES encryption and image-based steganography with integrity verification and real-time communication.
=======
